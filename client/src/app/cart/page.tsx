    ...
    return (
        <div className="flex flex-col gap-8 items-center justify-center mt-12">
            ...
            <div className="w-full flex flex-col lg:flex-row gap-16">
                {/*  Steps  */}
                <div
                    className="w-full lg:w-7/12 shadow-lg border broder-gray-100 p-8 rounded-lg flex flex-col gap-8"></div>
                {/*  Details  */}
                <div className="w-full lg:w-5/12 shadow-lg border broder-gray-100 p-8 rounded-lg flex flex-col gap-8">
